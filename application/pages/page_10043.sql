...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(67705170444295023627)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(67705170541667023627)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(67705170674826023627)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(67705170444295023627)
,p_button_name=>'NEXT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(67705172612721023628)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(67705170444295023627)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(67705173911304023629)
,p_branch_action=>'f?p=&APP_ID.:10044:&APP_SESSION.::&DEBUG.:RP,10044::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(67705170674826023627)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(67705174318421023629)
,p_name=>'P10043_ROLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(67705170541667023627)
,p_item_default=>'2'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(67705174766373023630)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(67705175152572023630)
...
,p_lov=>'.'||wwv_flow_imp.id(67705175240263023630)||'.'
,p_field_template=>wwv_flow_imp.id(67705014904991022560)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_attribute_01=>'1'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(67705172767645023628)
,p_name=>unistr('Cancelar Caixa de Di\00E1logo')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(67705172612721023628)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(67705173470681023629)
,p_event_id=>wwv_flow_imp.id(67705172767645023628)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(67705176289255023631)
...
,p_process_when_button_id=>wwv_flow_imp.id(67705170674826023627)
);
