...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(67705186996892023862)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(67705187015987023862)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(67705187117540023862)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(67705187015987023862)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(67705190123619023863)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(67705187015987023862)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(67705197866535023868)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(67705191421030023864)
,p_name=>'P10050_APPLICATION_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(67705186996892023862)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(67705191816398023864)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(67705192299064023864)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(67705192610397023865)
...
,p_lov=>'.'||wwv_flow_imp.id(67705192737145023865)||'.'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(67705194588098023866)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(67705197434489023868)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(67705190287519023863)
,p_name=>unistr('Cancelar Caixa de Di\00E1logo')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(67705190123619023863)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(67705190968478023864)
,p_event_id=>wwv_flow_imp.id(67705190287519023863)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(67705194979463023866)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(67705187117540023862)
,p_process_success_message=>'Feedback Enviado'
);
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(67705195401537023867)
,p_page_process_id=>wwv_flow_imp.id(67705194979463023866)
,p_page_id=>10050
,p_name=>'p_comment'
,p_direction=>'IN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(67705195965529023867)
,p_page_process_id=>wwv_flow_imp.id(67705194979463023866)
,p_page_id=>10050
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(67705196470325023867)
,p_page_process_id=>wwv_flow_imp.id(67705194979463023866)
,p_page_id=>10050
,p_name=>'p_page_id'
,p_direction=>'IN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(67705196905602023867)
,p_page_process_id=>wwv_flow_imp.id(67705194979463023866)
,p_page_id=>10050
,p_name=>'p_rating'
,p_direction=>'IN'
