...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(67704863467510022480)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704863788747022480)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704864058721022480)
,p_page_template_id=>wwv_flow_imp.id(67704863467510022480)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704864374163022481)
,p_page_template_id=>wwv_flow_imp.id(67704863467510022480)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704864612448022481)
,p_page_template_id=>wwv_flow_imp.id(67704863467510022480)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704864928763022481)
,p_page_template_id=>wwv_flow_imp.id(67704863467510022480)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704865243288022481)
,p_page_template_id=>wwv_flow_imp.id(67704863467510022480)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704865521929022481)
,p_page_template_id=>wwv_flow_imp.id(67704863467510022480)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704865881260022481)
,p_page_template_id=>wwv_flow_imp.id(67704863467510022480)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704866193581022481)
,p_page_template_id=>wwv_flow_imp.id(67704863467510022480)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704866468905022481)
,p_page_template_id=>wwv_flow_imp.id(67704863467510022480)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704866757676022482)
,p_page_template_id=>wwv_flow_imp.id(67704863467510022480)
