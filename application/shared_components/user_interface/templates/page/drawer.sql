...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(67704841329733022466)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704841627431022467)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704841938405022467)
,p_page_template_id=>wwv_flow_imp.id(67704841329733022466)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704842200736022467)
,p_page_template_id=>wwv_flow_imp.id(67704841329733022466)
