...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(67704861900730022479)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704862251978022479)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704862544906022479)
,p_page_template_id=>wwv_flow_imp.id(67704861900730022479)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704862879734022479)
,p_page_template_id=>wwv_flow_imp.id(67704861900730022479)
