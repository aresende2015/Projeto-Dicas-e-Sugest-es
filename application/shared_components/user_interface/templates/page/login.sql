...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(67704851916719022473)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704852287831022474)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704852526342022474)
,p_page_template_id=>wwv_flow_imp.id(67704851916719022473)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704852854018022474)
,p_page_template_id=>wwv_flow_imp.id(67704851916719022473)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704853109361022474)
,p_page_template_id=>wwv_flow_imp.id(67704851916719022473)
,p_name=>'Body Footer'
