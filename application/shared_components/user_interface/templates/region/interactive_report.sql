...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(67704933436631022518)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704933753528022518)
,p_plug_template_id=>wwv_flow_imp.id(67704933436631022518)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704934014966022518)
,p_plug_template_id=>wwv_flow_imp.id(67704933436631022518)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704934324365022518)
,p_plug_template_id=>wwv_flow_imp.id(67704933436631022518)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704934666401022518)
,p_plug_template_id=>wwv_flow_imp.id(67704933436631022518)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704934957045022518)
,p_plug_template_id=>wwv_flow_imp.id(67704933436631022518)
,p_name=>'Sub Regions'
