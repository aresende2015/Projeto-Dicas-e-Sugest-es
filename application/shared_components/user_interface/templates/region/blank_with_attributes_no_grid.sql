...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(67704878691488022491)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704878956877022491)
,p_plug_template_id=>wwv_flow_imp.id(67704878691488022491)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704879289922022491)
,p_plug_template_id=>wwv_flow_imp.id(67704878691488022491)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704879508586022492)
,p_plug_template_id=>wwv_flow_imp.id(67704878691488022491)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704879829373022492)
,p_plug_template_id=>wwv_flow_imp.id(67704878691488022491)
,p_name=>'Sub Regions'
