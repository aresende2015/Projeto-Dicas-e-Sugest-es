...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(67704938010960022520)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704938334263022520)
,p_plug_template_id=>wwv_flow_imp.id(67704938010960022520)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704938615313022520)
,p_plug_template_id=>wwv_flow_imp.id(67704938010960022520)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704938916244022520)
,p_plug_template_id=>wwv_flow_imp.id(67704938010960022520)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704939202104022520)
,p_plug_template_id=>wwv_flow_imp.id(67704938010960022520)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704939510550022520)
,p_plug_template_id=>wwv_flow_imp.id(67704938010960022520)
,p_name=>'Sub Regions'
