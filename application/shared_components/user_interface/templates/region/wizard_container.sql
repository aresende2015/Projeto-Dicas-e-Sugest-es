...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(67704960428119022530)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704960703419022531)
,p_plug_template_id=>wwv_flow_imp.id(67704960428119022530)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704961045379022531)
,p_plug_template_id=>wwv_flow_imp.id(67704960428119022530)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704961320455022531)
,p_plug_template_id=>wwv_flow_imp.id(67704960428119022530)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704961642803022531)
,p_plug_template_id=>wwv_flow_imp.id(67704960428119022530)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704961935778022531)
,p_plug_template_id=>wwv_flow_imp.id(67704960428119022530)
