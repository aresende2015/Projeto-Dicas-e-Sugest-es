...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(67704935597851022519)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704935879781022519)
,p_plug_template_id=>wwv_flow_imp.id(67704935597851022519)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704936119185022519)
,p_plug_template_id=>wwv_flow_imp.id(67704935597851022519)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704936439522022519)
,p_plug_template_id=>wwv_flow_imp.id(67704935597851022519)
,p_name=>'Button Start'
