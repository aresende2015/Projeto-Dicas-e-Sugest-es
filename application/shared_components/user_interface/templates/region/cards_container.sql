...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(67704884399284022494)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704884691074022494)
,p_plug_template_id=>wwv_flow_imp.id(67704884399284022494)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704884970657022494)
,p_plug_template_id=>wwv_flow_imp.id(67704884399284022494)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704885264996022494)
,p_plug_template_id=>wwv_flow_imp.id(67704884399284022494)
,p_name=>'Sub Regions'
