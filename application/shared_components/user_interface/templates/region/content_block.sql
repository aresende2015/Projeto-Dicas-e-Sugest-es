...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(67704905676247022504)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704905910005022505)
,p_plug_template_id=>wwv_flow_imp.id(67704905676247022504)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704906227371022505)
,p_plug_template_id=>wwv_flow_imp.id(67704905676247022504)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704906563558022505)
,p_plug_template_id=>wwv_flow_imp.id(67704905676247022504)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704906860376022505)
,p_plug_template_id=>wwv_flow_imp.id(67704905676247022504)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704907180773022505)
,p_plug_template_id=>wwv_flow_imp.id(67704905676247022504)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704907442387022505)
,p_plug_template_id=>wwv_flow_imp.id(67704905676247022504)
,p_name=>'Sub Regions'
