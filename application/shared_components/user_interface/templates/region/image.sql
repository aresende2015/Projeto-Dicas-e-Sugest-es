...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(67704913487071022508)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704913728302022508)
,p_plug_template_id=>wwv_flow_imp.id(67704913487071022508)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704914099266022508)
,p_plug_template_id=>wwv_flow_imp.id(67704913487071022508)
,p_name=>'Sub Regions'
