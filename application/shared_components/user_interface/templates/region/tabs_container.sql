...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(67704953093707022527)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704953344423022527)
,p_plug_template_id=>wwv_flow_imp.id(67704953093707022527)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704953668718022527)
,p_plug_template_id=>wwv_flow_imp.id(67704953093707022527)
,p_name=>'Tabs'
