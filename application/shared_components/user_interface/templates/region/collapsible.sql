...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(67704896146625022500)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704896416295022500)
,p_plug_template_id=>wwv_flow_imp.id(67704896146625022500)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704896784875022500)
,p_plug_template_id=>wwv_flow_imp.id(67704896146625022500)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704897099136022500)
,p_plug_template_id=>wwv_flow_imp.id(67704896146625022500)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704897342988022501)
,p_plug_template_id=>wwv_flow_imp.id(67704896146625022500)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704897699350022501)
,p_plug_template_id=>wwv_flow_imp.id(67704896146625022500)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704897961612022501)
,p_plug_template_id=>wwv_flow_imp.id(67704896146625022500)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704898294565022501)
,p_plug_template_id=>wwv_flow_imp.id(67704896146625022500)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704898550985022501)
,p_plug_template_id=>wwv_flow_imp.id(67704896146625022500)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704898845934022501)
,p_plug_template_id=>wwv_flow_imp.id(67704896146625022500)
,p_name=>'Sub Regions'
