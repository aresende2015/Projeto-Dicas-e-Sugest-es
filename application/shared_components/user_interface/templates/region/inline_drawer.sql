...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(67704923448576022513)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704923768812022514)
,p_plug_template_id=>wwv_flow_imp.id(67704923448576022513)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704924092045022514)
,p_plug_template_id=>wwv_flow_imp.id(67704923448576022513)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704924308153022514)
,p_plug_template_id=>wwv_flow_imp.id(67704923448576022513)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704924620408022514)
,p_plug_template_id=>wwv_flow_imp.id(67704923448576022513)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704924951673022514)
,p_plug_template_id=>wwv_flow_imp.id(67704923448576022513)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704925215526022514)
,p_plug_template_id=>wwv_flow_imp.id(67704923448576022513)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704925541606022514)
,p_plug_template_id=>wwv_flow_imp.id(67704923448576022513)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704925899649022514)
,p_plug_template_id=>wwv_flow_imp.id(67704923448576022513)
,p_name=>'Sub Regions'
