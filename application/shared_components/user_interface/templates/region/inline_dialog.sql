...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(67704918890607022511)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704919181561022511)
,p_plug_template_id=>wwv_flow_imp.id(67704918890607022511)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704919453314022511)
,p_plug_template_id=>wwv_flow_imp.id(67704918890607022511)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704919782172022511)
,p_plug_template_id=>wwv_flow_imp.id(67704918890607022511)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704920052267022511)
,p_plug_template_id=>wwv_flow_imp.id(67704918890607022511)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704920369063022512)
,p_plug_template_id=>wwv_flow_imp.id(67704918890607022511)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704920689382022512)
,p_plug_template_id=>wwv_flow_imp.id(67704918890607022511)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704920956255022512)
,p_plug_template_id=>wwv_flow_imp.id(67704918890607022511)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704921274522022512)
,p_plug_template_id=>wwv_flow_imp.id(67704918890607022511)
,p_name=>'Sub Regions'
