...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(67704940544834022521)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704940818150022521)
,p_plug_template_id=>wwv_flow_imp.id(67704940544834022521)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704941164133022522)
,p_plug_template_id=>wwv_flow_imp.id(67704940544834022521)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704941428931022522)
,p_plug_template_id=>wwv_flow_imp.id(67704940544834022521)
,p_name=>'Sub Regions'
