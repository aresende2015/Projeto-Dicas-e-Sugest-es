...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(67704910285279022506)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704910524520022507)
,p_plug_template_id=>wwv_flow_imp.id(67704910285279022506)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704910823589022507)
,p_plug_template_id=>wwv_flow_imp.id(67704910285279022506)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704911165287022507)
,p_plug_template_id=>wwv_flow_imp.id(67704910285279022506)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704911499420022507)
,p_plug_template_id=>wwv_flow_imp.id(67704910285279022506)
,p_name=>'Sub Regions'
