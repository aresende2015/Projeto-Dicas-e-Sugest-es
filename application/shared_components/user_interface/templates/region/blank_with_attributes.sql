...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(67704877201885022490)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704877513520022490)
,p_plug_template_id=>wwv_flow_imp.id(67704877201885022490)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704877840462022491)
,p_plug_template_id=>wwv_flow_imp.id(67704877201885022490)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704878118604022491)
,p_plug_template_id=>wwv_flow_imp.id(67704877201885022490)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704878401232022491)
,p_plug_template_id=>wwv_flow_imp.id(67704877201885022490)
,p_name=>'Sub Regions'
