...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(67704928098620022515)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704928394264022516)
,p_plug_template_id=>wwv_flow_imp.id(67704928098620022515)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704928652281022516)
,p_plug_template_id=>wwv_flow_imp.id(67704928098620022515)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704928937132022516)
,p_plug_template_id=>wwv_flow_imp.id(67704928098620022515)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704929246372022516)
,p_plug_template_id=>wwv_flow_imp.id(67704928098620022515)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704929542216022516)
,p_plug_template_id=>wwv_flow_imp.id(67704928098620022515)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704929872662022516)
,p_plug_template_id=>wwv_flow_imp.id(67704928098620022515)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704930146337022516)
,p_plug_template_id=>wwv_flow_imp.id(67704928098620022515)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(67704930460882022516)
,p_plug_template_id=>wwv_flow_imp.id(67704928098620022515)
,p_name=>'Sub Regions'
